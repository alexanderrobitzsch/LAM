...
double lam_loglike_mvnorm_rcpp(arma::colvec M, arma::mat S, arma::colvec mu, arma::mat Sigma, double n, bool use_log, double lambda, bool ginv, double eps);
static SEXP _LAM_lam_loglike_mvnorm_rcpp_try(SEXP MSEXP, SEXP SSEXP, SEXP muSEXP, SEXP SigmaSEXP, SEXP nSEXP, SEXP use_logSEXP, SEXP lambdaSEXP, SEXP ginvSEXP, SEXP epsSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(lam_loglike_mvnorm_rcpp(M, S, mu, Sigma, n, use_log, lambda, ginv, eps));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _LAM_lam_loglike_mvnorm_rcpp(SEXP MSEXP, SEXP SSEXP, SEXP muSEXP, SEXP SigmaSEXP, SEXP nSEXP, SEXP use_logSEXP, SEXP lambdaSEXP, SEXP ginvSEXP, SEXP epsSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_LAM_lam_loglike_mvnorm_rcpp_try(MSEXP, SSEXP, muSEXP, SigmaSEXP, nSEXP, use_logSEXP, lambdaSEXP, ginvSEXP, epsSEXP));
    }
...
double lam_loglike_mvnorm_na_pattern_rcpp(Rcpp::List suff_stat, arma::colvec mu, arma::mat Sigma, bool use_log, double lambda, bool ginv, double eps);
static SEXP _LAM_lam_loglike_mvnorm_na_pattern_rcpp_try(SEXP suff_statSEXP, SEXP muSEXP, SEXP SigmaSEXP, SEXP use_logSEXP, SEXP lambdaSEXP, SEXP ginvSEXP, SEXP epsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    ...
    Rcpp::traits::input_parameter< bool >::type ginv(ginvSEXP);
    Rcpp::traits::input_parameter< double >::type eps(epsSEXP);
    rcpp_result_gen = Rcpp::wrap(lam_loglike_mvnorm_na_pattern_rcpp(suff_stat, mu, Sigma, use_log, lambda, ginv, eps));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _LAM_lam_loglike_mvnorm_na_pattern_rcpp(SEXP suff_statSEXP, SEXP muSEXP, SEXP SigmaSEXP, SEXP use_logSEXP, SEXP lambdaSEXP, SEXP ginvSEXP, SEXP epsSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_LAM_lam_loglike_mvnorm_na_pattern_rcpp_try(suff_statSEXP, muSEXP, SigmaSEXP, use_logSEXP, lambdaSEXP, ginvSEXP, epsSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _LAM_RcppExport_validate(const char* sig) { 
    static std::set<std::string> signatures;
    if (signatures.empty()) {
        signatures.insert("double(*lam_loglike_mvnorm_rcpp)(arma::colvec,arma::mat,arma::colvec,arma::mat,double,bool,double,bool,double)");
        signatures.insert("double(*lam_loglike_mvnorm_na_pattern_rcpp)(Rcpp::List,arma::colvec,arma::mat,bool,double,bool,double)");
    }
    return signatures.find(sig) != signatures.end();
}

// registerCCallable (register entry points for exported C++ functions)
RcppExport SEXP _LAM_RcppExport_registerCCallable() { 
    R_RegisterCCallable("LAM", "_LAM_lam_loglike_mvnorm_rcpp", (DL_FUNC)_LAM_lam_loglike_mvnorm_rcpp_try);
    R_RegisterCCallable("LAM", "_LAM_lam_loglike_mvnorm_na_pattern_rcpp", (DL_FUNC)_LAM_lam_loglike_mvnorm_na_pattern_rcpp_try);
    R_RegisterCCallable("LAM", "_LAM_RcppExport_validate", (DL_FUNC)_LAM_RcppExport_validate);
    return R_NilValue;
}

static const R_CallMethodDef CallEntries[] = {
    {"_LAM_lam_loglike_mvnorm_rcpp", (DL_FUNC) &_LAM_lam_loglike_mvnorm_rcpp, 9},
    {"_LAM_lam_loglike_mvnorm_na_pattern_rcpp", (DL_FUNC) &_LAM_lam_loglike_mvnorm_na_pattern_rcpp, 7},
    ...
    {"_LAM_RcppExport_registerCCallable", (DL_FUNC) &_LAM_RcppExport_registerCCallable, 0},
    {NULL, NULL, 0}
};
